...
<body>
    ...
    <div class="padding"> 
        ...
        <?php
            ...
            //Requête
            $result = $connex->requete("SELECT libelle_maladie,rayon_prot,rayon_surv,date_fin,id_zone_tampon, active FROM zone_tampon zt JOIN maladie m on m.id_maladie=zt.id_maladie WHERE active='t'");
        ?>
        <div class="container">
