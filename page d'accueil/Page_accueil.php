...
<body> 
    ...
    //Module saisie prophylaxie (véto seulement)
        ...
        if (in_array($type,$tab_saisi_pro)){    
            ...
            echo "<center><p> Consulter la liste des prophylaxies</p></center>";
    ...
    <!-- Module Documents-->
        <br><div class='col-lg-3'>
            ...
            <center><br><a class='btn bouton-sonnaille' href="../documents/consultation_document.php" role='button'>Liste des documents</a></center>
        </div>
