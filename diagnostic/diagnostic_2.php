		...
		while ($row = pg_fetch_array($result, null, PGSQL_NUM)) {
			...
			$id_labo=$row[0];
                ...
                $titre=pg_escape_string("Demande d'analyse");
                 //Ajout d'une notification � la base de donn�e 
                $query=$connex->requete("INSERT INTO notification (id_notification, date_notification, titre_notification, message)  VALUES (".$id.",'".$date."','".$titre."','Votre laboratoire a ete choisit par :".$nom_v�to." pour effectuer une Analyse')");
