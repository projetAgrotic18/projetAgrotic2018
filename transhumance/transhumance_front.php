...
<html>
    ...
    <body>
        ...
        //RÈcupÈration de l'id du compte
        $id_compte = $_SESSION['id_compte'];
	
        //RequÍte SQL pour l'id de lot de mouvement transhumance
        ...
        //on rÈcupere l'id max des notifications
        $id=$row_last_id[0]+1;
         
        //RequÍte pour aller chercher les communes pour l'auto complÈtion
        $rqt="SELECT nom_commune,code_postal FROM commune";
        $result2 = $connex->requete($rqt);
        $array = array(); // on crÈÈ le tableau pour l'autocomplÈtion, qui stocke les communes
        ...
        <!--Fonction de validation et vÈrification du formulaire-->
        ...
        <!--Code pour l'autocomplÈtion de la commune-->
        <script type="text/javascript"> 
            ...
            <div class="fond_gris">
                <div class="padding">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                                <label for="nom_eleveur">(*) PrÈnom</label>
